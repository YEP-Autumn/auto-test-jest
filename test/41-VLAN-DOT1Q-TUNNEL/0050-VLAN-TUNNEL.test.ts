...
test("支持为没有VLAN Tag的报文添加双层Tag", async () => {
  testHelper.ExecConfigDutA([
    ...
    "exit",
    "ethernet evc 1",
    "dot1q mapped-double-vlan 180 200",
    "exit",
  ...
  /**
   * RenixA发送不带vlan的报文，RenixB能够收到vlan 180/200的报文
   * RenixB发送vlan 180/200的报文，RenixB能够收到不带vlan的报文
   */
